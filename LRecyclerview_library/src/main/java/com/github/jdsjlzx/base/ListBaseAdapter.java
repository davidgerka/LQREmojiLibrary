...
public abstract class ListBaseAdapter<T> extends RecyclerView.Adapter<SuperViewHolder> {
     ...
     * 构造方法
     * @param context               //上下文
     * @param needModifyRootView    //是否需要对布局进行添加View或者其他操作
     */
    public ListBaseAdapter(Context context, boolean needModifyRootView) {
        mContext = context;
    ...
    public SuperViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if(needModifyRootView){
            modifyItemViewGroup((ViewGroup) itemView, mInflater);
        }
    ...
    public void modifyItemViewGroup(ViewGroup parent, LayoutInflater inflater){
