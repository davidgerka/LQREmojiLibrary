...
//            throw new RuntimeException("the adapter must be LRecyclerViewAdapter");
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (!isNormal && (lRecyclerViewAdapter == null || lRecyclerViewAdapter.isRefreshHeader(position)
                    || lRecyclerViewAdapter.isHeader(position) || lRecyclerViewAdapter.isFooter(position))) {
