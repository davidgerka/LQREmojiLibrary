package com.github.jdsjlzx.suspension;
...
public class SuspensionDecoration extends RecyclerView.ItemDecoration {
    ...
    private static int TITLE_TEXT_COLOR = Color.parseColor("#FF999999");
    private static int mTitleTextSize;//title字体大小
    ...
    public SuspensionDecoration setTitleHeightDimen(@DimenRes int resource) {
        setTitleHeight(mContext.getResources().getDimensionPixelSize(resource));
        return this;
    }
    ...
    public SuspensionDecoration setTitleBgColorAttr(@AttrRes int resource) {
        TypedValue typedValue = new TypedValue();
        mContext.getTheme().resolveAttribute(resource, typedValue, true);
        setTitleBgColorRes(typedValue.resourceId);
        return this;
    }

    public SuspensionDecoration setTitleBgColorRes(@ColorRes int resource) {
        setTitleBgColor(ContextCompat.getColor(mContext, resource));
        return this;
    }

    public SuspensionDecoration setTitleBgColor(int colorTitleBg) {
        TITLE_BG_COLOR = colorTitleBg;
        return this;
    }

    public SuspensionDecoration setTitleTextColorAttr(@AttrRes int resource) {
        TypedValue typedValue = new TypedValue();
        mContext.getTheme().resolveAttribute(resource, typedValue, true);
        setTitleTextClolorRes(typedValue.resourceId);
        return this;
    }

    public SuspensionDecoration setTitleTextClolorRes(@ColorRes int resource) {
        setTitleTextColor(ContextCompat.getColor(mContext, resource));
        return this;
    }

    public SuspensionDecoration setTitleTextColor(int colorTitleFont) {
        TITLE_TEXT_COLOR = colorTitleFont;
        return this;
    }

    public SuspensionDecoration setTitleTextSize(int mTitleFontSize) {
